...
namespace Pluralsight.Migrations
{
    ...
    [Migration("20210723210452_initmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Camp", b =>
                {
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Speaker", b =>
                {
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Talk", b =>
                {
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Camp", b =>
                {
                    b.HasOne("Pluralsight.Data.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("Pluralsight.Data.Entities.Talk", b =>
                {
                    b.HasOne("Pluralsight.Data.Entities.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("Pluralsight.Data.Entities.Speaker", "Speaker")
                        .WithMany()
